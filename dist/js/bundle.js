...
/* harmony import */ var _parts_ajax_ajax__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parts/ajax/ajax */ "./src/js/parts/ajax/ajax.js");
/* harmony import */ var _parts_ajax_views__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parts/ajax/views */ "./src/js/parts/ajax/views.js");
/* harmony import */ var _parts_ajax_post_expand__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parts/ajax/post-expand */ "./src/js/parts/ajax/post-expand.js");
/* harmony import */ var _parts_ajax_archive_tezaurus__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./parts/ajax/archive-tezaurus */ "./src/js/parts/ajax/archive-tezaurus.js");
...
const getRequest = (met, dataData, func, button) => {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        data: dataData,
        beforeSend: () => {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-preloader]').addClass('preloader--active');
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css('overflow', 'hidden');
        },
        success: (data) => {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-preloader]').removeClass('preloader--active');
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _ajax__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ajax */ "./src/js/parts/ajax/ajax.js");


const letterButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('button[data-letter]');
const inputSearch = jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.thesaurus_search');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'button[data-letter]', (evt) => {
    evt.preventDefault();
    ...
    _ajax__WEBPACK_IMPORTED_MODULE_1__["default"].getRequest('GET', dataTezaurus, getTezaurus);
});

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', 'input.thesaurus_search', () => {
    let dataTezaurus = {
        action: 'search_by_letter',
        letter: jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.thesaurus_search').val().trim().toLowerCase()
    };
    _ajax__WEBPACK_IMPORTED_MODULE_1__["default"].getRequest('GET', dataTezaurus, getTezaurus);
});
...
expandButtons.forEach((button) => {
    ...
    button.addEventListener('click', (e) => {
        ...
        if (button.innerHTML === button.dataset['expandText']){
            ...
            _ajax__WEBPACK_IMPORTED_MODULE_1__["default"].getRequest('POST', dataExpand, postExpand, button);
...
const singlePost = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.single-post[data-post]');
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _parts_ajax_ajax__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../parts/ajax/ajax */ "./src/js/parts/ajax/ajax.js");
...
function render_posts(container, append = false) {
    ...
    _parts_ajax_ajax__WEBPACK_IMPORTED_MODULE_1__["default"].getRequest('GET', data, handler);
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '[data-sorting-name]', (e) => {
    e.preventDefault();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).closest('.section-head').find('button[data-sorting]').removeClass('button-sorting--active');
});

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '[data-load-more]', (evt) => {
    evt.preventDefault();
    const el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(evt.currentTarget);
    render_posts(el.closest('[data-post-container]'), true);
})

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'button[data-sorting]', (e) => {
    e.preventDefault();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).mouseup(function (e){ // событие клика по веб-документу
    const el = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-sorting]'); // тут указываем ID элемента
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).bind('scroll', (e)=> {
    loadMore();
});

function loadMore() {
    const containers = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-post-container]');
    containers.each((i, el) => {
        const rect = el.getBoundingClientRect();
        
        const bottom = rect.bottom - jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height();
        
        if(bottom <= 150 && bottom >= -150 && send == true) {
            console.log(bottom);
            send = false;
            render_posts(jquery__WEBPACK_IMPORTED_MODULE_0___default()(el), true);
